...
namespace BiometricAttendance.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InstructorPasses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PassCode = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorPasses", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fingerprints_StudentId",
                table: "Fingerprints",
                column: "StudentId",
                unique: true);
