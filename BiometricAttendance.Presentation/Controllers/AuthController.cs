...
using BiometricAttendance.Application.Features.Auth.ConfirmEmail;
using BiometricAttendance.Application.Features.Auth.GetRefreshToken;
using BiometricAttendance.Application.Features.Auth.GetToken;
using BiometricAttendance.Application.Features.Auth.Register;
using BiometricAttendance.Application.Features.Auth.ResendConfirmationEmail;
using BiometricAttendance.Application.Features.Auth.ResetPassword;
using BiometricAttendance.Application.Features.Auth.RevokeRefreshToken;
using BiometricAttendance.Application.Features.Auth.SendResetPassword;
...
public class AuthController(ISender sender) : ControllerBase
{
    ...
    /// </summary>
    /// <remarks>
    /// Logs in a user using their email/username and password, returning an access token and a refresh token.
    /// 
    /// Sample request:
    /// 
    ///     POST /Auth
    ...
    {
        var command = new GetTokenCommand(request.Identifier, request.Password);
    ...
    {
        var command = new SendResetPasswordCommand(request.Email);
        var result = await _sender.Send(command, cancellationToken);
